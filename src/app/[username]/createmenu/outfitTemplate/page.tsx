...
import { BackArrowIcon, UploadIcon } from "../../../../components/icons";
...
const CreateOutfitView: React.FC<CreateOutfitViewProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    additionalStyle: outfitToEdit?.prompt || "",
    previewImageUrl: outfitToEdit?.previewImageUrl || "",
    type: outfitToEdit?.type || "",
  });
