...
const PostView: React.FC<PostViewProps> = ({ selectedImage, onClose, isOwner, onCreateYourOwn }) => {
        ...
        <div className="relative bg-base-100 dark:bg-dark-base-100 p-4 rounded-lg shadow-xl max-w-3xl w-full" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="mt-4 flex flex-col items-center gap-2">
            <div className="flex justify-center gap-4">
              <button onClick={handleDownload} className="px-6 py-2 bg-brand-primary text-white font-bold rounded-lg hover:bg-brand-secondary transition-colors flex items-center justify-center w-36">
                Download
              </button>
              <button
