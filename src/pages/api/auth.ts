...
const API_KEY = process.env.FIREBASE_API_KEY || "AIzaSyC3VR98pOpdsYZBlkBCsB8fvUwpvOPlJ1g";
    ...
    try {
        switch (action) {
            ...
            case 'refreshToken':
                ...
                const refreshResponse = await fetch(`${AUTH_BASE_URL}:token?key=${API_KEY}`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                ...
                const refreshedUser: User = {
                    ...
                    idToken: refreshData.access_token,
